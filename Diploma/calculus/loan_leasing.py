...
def economic_substation(aircraft_info, years, guaranteed_deposit, annual_rate_on_leasing,
    ...
    interest_for_each_year = calculate_interest_for_each_year(price=price, annual_loan_amount=annual_loan_amount,
    ...
    aircraft_cost_under_loan = calculate_aircraft_cost_under_loan_structure(price=price,
                                                                            total_interest_rate=total_interest_rate)

    price_of_guaranteed_deposit = calculate_price_of_guaranteed_deposit(price=price,
    ...
    aircraft_cost_under_leasing = calculate_aircraft_cost_under_leasing(
        price_of_guaranteed_deposit=price_of_guaranteed_deposit, aircraft_price_looses=aircraft_price_looses,
        income_tax_rate=income_tax_rate, annual_interest_rate_on_capital_market=annual_interest_rate_on_capital_market,
        years=years)
    residual_value = calculate_residual_value_for_leasing(aircraft_cost_under_leasing=aircraft_cost_under_leasing,
                                                          price=price)
